...
d3.csv("data/data.csv",function(d) {
	...
	o[0] = +d.lon;
	o[1] = +d.lat;
	o.className = d.place.toLowerCase().replace(/[^\w\s]+/g, "").replace(/\s/g,"_") + "_" + d.stateabrev;
	o.place = d.place;
	o.stateabrev = d.stateabrev;
	o.rankeconhealth1980 = +d.rankeconhealth1980;
	o.rankeconinclusionindex1980 = +d.rankeconinclusionindex1980;
	o.rankraceinclusionindex1980 = +d.rankraceinclusionindex1980;
	o.rankoverallinclusionindex1980 = +d.rankoverallinclusionindex1980;
	o.rankeconhealth1990 = +d.rankeconhealth1990;
	o.rankeconinclusionindex1990 = +d.rankeconinclusionindex1990;
	o.rankraceinclusionindex1990 = +d.rankraceinclusionindex1990;
	o.rankoverallinclusionindex1990 = +d.rankoverallinclusionindex1990;
	o.rankeconhealth2000 = +d.rankeconhealth2000;
	o.rankeconinclusionindex2000 = +d.rankeconinclusionindex2000;
	o.rankraceinclusionindex2000 = +d.rankraceinclusionindex2000;
	o.rankoverallinclusionindex2000 = +d.rankoverallinclusionindex2000;
	o.rankeconhealth2013 = +d.rankeconhealth2013;
	o.rankeconinclusionindex2013 = +d.rankeconinclusionindex2013;
	o.rankraceinclusionindex2013 = +d.rankraceinclusionindex2013;
	o.rankoverallinclusionindex2013 = +d.rankoverallinclusionindex2013;
	o.pop1980 = +d.pop1980;
	o.pop1990 = +d.pop1990;
	o.pop2000 = +d.pop2000;
	o.pop2013 = +d.pop2013;
	o.logpop1980 =  Math.log10(+d.pop1980);
	o.logpop1990 = Math.log10(+d.pop1990);
	o.logpop2000 = Math.log10(+d.pop2000);
	o.logpop2013 = Math.log10(+d.pop2013);
	o.everrecover = (d.everrecover == 1);
	o.recoverstart = (d.recovperiod != "x") ? +(d.recovperiod.split("-")[0]) : 0;
	o.recoverend = (d.recovperiod != "x") ? +(d.recovperiod.split("-")[1]) : 0;
	o.consolidated = +d.consolidated;
	o.pctemploymentchange1980 = +d.pctemploymentchange1980;
	o.MEANpctemploymentchange1980 = +d.MEANpctemploymentchange1980;
	o.pctemploymentchange1990 = +d.pctemploymentchange1990;
	o.MEANpctemploymentchange1990 = +d.MEANpctemploymentchange1990;
	o.pctemploymentchange2000 = +d.pctemploymentchange2000;
	o.MEANpctemploymentchange2000 = +d.MEANpctemploymentchange2000;
	o.pctemploymentchange2013 = +d.pctemploymentchange2013;
	o.MEANpctemploymentchange2013 = +d.MEANpctemploymentchange2013;
	o.unemprate1980 = +d.unemprate1980;
	o.MEANunemprate1980 = +d.MEANunemprate1980;
	o.unemprate1990 = +d.unemprate1990;
	o.MEANunemprate1990 = +d.MEANunemprate1990;
	o.unemprate2000 = +d.unemprate2000;
	o.MEANunemprate2000 = +d.MEANunemprate2000;
	o.unemprate2013 = +d.unemprate2013;
	o.MEANunemprate2013 = +d.MEANunemprate2013;
	o.vacancyrate1980 = +d.vacancyrate1980;
	o.MEANvacancyrate1980 = +d.MEANvacancyrate1980;
	o.vacancyrate1990 = +d.vacancyrate1990;
	o.MEANvacancyrate1990 = +d.MEANvacancyrate1990;
	o.vacancyrate2000 = +d.vacancyrate2000;
	o.MEANvacancyrate2000 = +d.MEANvacancyrate2000;
	o.vacancyrate2013 = +d.vacancyrate2013;
	o.MEANvacancyrate2013 = +d.MEANvacancyrate2013;
	o.medfamincome1980 = +d.medfamincome1980;
	o.MEANmedfamincome1980 = +d.MEANmedfamincome1980;
	o.medfamincome1990 = +d.medfamincome1990;
	o.MEANmedfamincome1990 = +d.MEANmedfamincome1990;
	o.medfamincome2000 = +d.medfamincome2000;
	o.MEANmedfamincome2000 = +d.MEANmedfamincome2000;
	o.medfamincome2013 = +d.medfamincome2013;
	o.MEANmedfamincome2013 = +d.MEANmedfamincome2013;
	o.Citypctnonwhite1980 = +d.Citypctnonwhite1980;
	o.MEANCitypctnonwhite1980 = +d.MEANCitypctnonwhite1980;
	o.Citypctnonwhite1990 = +d.Citypctnonwhite1990;
	o.MEANCitypctnonwhite1990 = +d.MEANCitypctnonwhite1990;
	o.Citypctnonwhite2000 = +d.Citypctnonwhite2000;
	o.MEANCitypctnonwhite2000 = +d.MEANCitypctnonwhite2000;
	o.Citypctnonwhite2013 = +d.Citypctnonwhite2013;
	o.MEANCitypctnonwhite2013 = +d.MEANCitypctnonwhite2013;
	o.RacialSeg1980 = +d.RacialSeg1980;
	o.MEANRacialSeg1980 = +d.MEANRacialSeg1980;
	o.RacialSeg1990 = +d.RacialSeg1990;
	o.MEANRacialSeg1990 = +d.MEANRacialSeg1990;
	o.RacialSeg2000 = +d.RacialSeg2000;
	o.MEANRacialSeg2000 = +d.MEANRacialSeg2000;
	o.RacialSeg2013 = +d.RacialSeg2013;
	o.MEANRacialSeg2013 = +d.MEANRacialSeg2013;
	o.hogap1980 = +d.hogap1980 * 100;
	o.MEANhogap1980 = +d.MEANhogap1980 * 100;
	o.hogap1990 = +d.hogap1990 * 100;
	o.MEANhogap1990 = +d.MEANhogap1990 * 100;
	o.hogap2000 = +d.hogap2000 * 100;
	o.MEANhogap2000 = +d.MEANhogap2000 * 100;
	o.hogap2013 = +d.hogap2013 * 100;
	o.MEANhogap2013 = +d.MEANhogap2013 * 100;
	o.povgap1980 = +d.povgap1980 * 100;
	o.MEANpovgap1980 = +d.MEANpovgap1980 * 100;
	o.povgap1990 = +d.povgap1990 * 100;
	o.MEANpovgap1990 = +d.MEANpovgap1990 * 100;
	o.povgap2000 = +d.povgap2000 * 100;
	o.MEANpovgap2000 = +d.MEANpovgap2000 * 100;
	o.povgap2013 = +d.povgap2013 * 100;
	o.MEANpovgap2013 = +d.MEANpovgap2013 * 100;
	o.racialeducationgap1980 = +d.racialeducationgap1980 * 100;
	o.MEANracialeducationgap1980 = +d.MEANracialeducationgap1980 * 100;
	o.racialeducationgap1990 = +d.racialeducationgap1990 * 100;
	o.MEANracialeducationgap1990 = +d.MEANracialeducationgap1990 * 100;
	o.racialeducationgap2000 = +d.racialeducationgap2000 * 100;
	o.MEANracialeducationgap2000 = +d.MEANracialeducationgap2000 * 100;
	o.racialeducationgap2013 = +d.racialeducationgap2013 * 100;
	o.MEANracialeducationgap2013 = +d.MEANracialeducationgap2013 * 100;
	o.incseg1980 = +d.incseg1980;
	o.MEANincseg1980 = +d.MEANincseg1980;
	o.incseg1990 = +d.incseg1990;
	o.MEANincseg1990 = +d.MEANincseg1990;
	o.incseg2000 = +d.incseg2000;
	o.MEANincseg2000 = +d.MEANincseg2000;
	o.incseg2013 = +d.incseg2013;
	o.MEANincseg2013 = +d.MEANincseg2013;
	o.rentburden1980 = +d.rentburden1980;
	o.MEANrentburden1980 = +d.MEANrentburden1980;
	o.rentburden1990 = +d.rentburden1990;
	o.MEANrentburden1990 = +d.MEANrentburden1990;
	o.rentburden2000 = +d.rentburden2000;
	o.MEANrentburden2000 = +d.MEANrentburden2000;
	o.rentburden2013 = +d.rentburden2013;
	o.MEANrentburden2013 = +d.MEANrentburden2013;
	o.workingpoor1980 = +d.workingpoor1980;
	o.MEANworkingpoor1980 = +d.MEANworkingpoor1980;
	o.workingpoor1990 = +d.workingpoor1990;
	o.MEANworkingpoor1990 = +d.MEANworkingpoor1990;
	o.workingpoor2000 = +d.workingpoor2000;
	o.MEANworkingpoor2000 = +d.MEANworkingpoor2000;
	o.workingpoor2013 = +d.workingpoor2013;
	o.MEANworkingpoor2013 = +d.MEANworkingpoor2013;
	o.pct1619notinschool1980 = +d.pct1619notinschool1980;
	o.MEANpct1619notinschool1980 = +d.MEANpct1619notinschool1980;
	o.pct1619notinschool1990 = +d.pct1619notinschool1990;
	o.MEANpct1619notinschool1990 = +d.MEANpct1619notinschool1990;
	o.pct1619notinschool2000 = +d.pct1619notinschool2000;
	o.MEANpct1619notinschool2000 = +d.MEANpct1619notinschool2000;
	o.pct1619notinschool2013 = +d.pct1619notinschool2013;
	o.MEANpct1619notinschool2013 = +d.MEANpct1619notinschool2013;
